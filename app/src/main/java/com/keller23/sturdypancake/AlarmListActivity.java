...
import com.keller23.sturdypancake.dummy.DummyContent;
...
public class AlarmListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.alarm_list);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(AlarmDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(AlarmDetailFragment.ARG_ITEM_ID, holder.mItem.id);
